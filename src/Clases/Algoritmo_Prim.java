...
import static Ventanas.VentanaPrincipal.jPanel2;
    ...
    public void prim() {
        ...
        do {
            ...
            if (aumentaTamano == true) {
                ...
                Pintar.pintarCamino(jPanel2.getGraphics(), arboles.getCordeX(nodoApuntador), arboles.getCordeY(nodoApuntador), arboles.getCordeX(nodoApuntado), arboles.getCordeY(nodoApuntado), Color.blue, String.valueOf(arboles.getNombre(nodoApuntador)), String.valueOf(arboles.getNombre(nodoApuntado)), String.valueOf(arboles.getNombre(this.aristaMenor)));
                
                
                
                Pintar.clickSobreNodo(jPanel2.getGraphics(), arboles.getCordeX(nodoApuntador), arboles.getCordeY(nodoApuntador), null, Color.blue);
                Pintar.clickSobreNodo(jPanel2.getGraphics(), arboles.getCordeX(nodoApuntado), arboles.getCordeY(nodoApuntado), null, Color.blue);
